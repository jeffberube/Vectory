...
/**
 *
 * NOT MY CODE. THIS IS TAKEN AND MODIFIED FROM THE JAVAFX SKIN PACKAGE TO MAKE 
 * USE OF THE CUSTOMCOLORDIALOG.
 * 
 */
public class ColorPickerDialog extends HBox {
    private static double screenX = 200;
    private static double screenY = 200;
    ...
    public ColorPickerDialog(Window owner) {
    ...
    public void show() {
        ...
        ((Window)dialog).xProperty().addListener(e->screenX = ((Window)dialog).getX());
        ((Window)dialog).yProperty().addListener(e->screenY = ((Window)dialog).getY());
